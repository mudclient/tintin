...
//		"<268>      #<278>                                                                  <268>#\n"
	...
	},
	{
		...
		"           modes are: html, plain, raw, and stampless.\n"
		"\n"
...
//		"<268>         │<178>   yocto <268>│<178>      y <268>│<178>0.000 000 000 000 000 000 000 001<268>│\n"
	...
	},
	{
		...
		"         is used.\n"
		"\n"
		"<178>TinTin++ Description                                      POSIX\n"
		"<178>      %c <278>Match zero to any number of ansi color codes.    ((?:\\e\\[[0-9;]*m)*?)\n"
		"<178>      %d <278>Match zero to any number of digits               ([0-9]*?)\n"
		"<178>      %D <278>Match zero to any number of non-digits           ([^0-9]*?)\n"
		"<178>      %i <278>Matches become case insensitive                  (?i)\n"
		"<178>      %I <278>Matches become case sensitive (default)          (?-i)\n"
		"<178>      %s <278>Match zero to any number of spaces               ([\\r\\n\\t ]*?)\n"
		"<178>      %w <278>Match zero to any number of word characters      ([A-Za-z0-9_]*?)\n"
		"<178>      %W <278>Match zero to any number of non-word characters  ([^A-Za-z0-9_]*?)\n"
		"<178>      %? <278>Match zero or one character                      (.\?\?)\n"
		"<178>      %. <278>Match one character                              (.)\n"
		"<178>      %+ <278>Match one to any number of characters            (.+?)\n"
		"<178>      %* <278>Match zero to any number of characters           (.*?)\n"
		"\n"
		"         <128>Ranges\n"
		"\n"
