...
//		"<268>         │<178>   yocto <268>│<178>      y <268>│<178>0.000 000 000 000 000 000 000 001<268>│\n"
	...
	},
	{
		"TRIGGERS",
		TOKEN_TYPE_STRING,
		"         All available triggers in TinTin++ are displayed when you use the\n"
		"         #info command without an argument. All of them are written to file\n"
		"         when you use the #write command, except commands and paths.\n"
		"\n"
		...
		"         messages unless you have an event in the same category already set.\n"
		"\n"
		"<128>         Text triggers\n"
		"\n"
		...
		"         the trigger should start with a ~ tilda.\n"
		"\n"
		...
		"         multi-line trigger. A multi-line trigger is executed on incoming blocks\n"
		...
		"\n"
		"         Since the %* expression does not capture new lines it requires using\n"
		"         %a to capture multiple lines at once.\n"
		"\n"
		"         Multiple multi-line actions can trigger per block. Packet fragmentation\n"
		"         is not currently handled.\n"
		"\n"
		"         <138>Multi-line triggers are experimental and subject to change.\n"
		,
