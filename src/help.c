...
//		"<268>         │<178>   yocto <268>│<178>      y <268>│<178>0.000 000 000 000 000 000 000 001<268>│\n"
	...
	},
	{
		...
		"\n"
		"         Since the %* expression does not capture new lines it is required to\n"
		"         use %a to capture multiple lines. To capture the start of the block\n"
		"         use \\A and for the end use \\Z. You can use ^ and $ to capture the\n"
		"         start and end of a line.\n"
		"\n"
		"         Multi-line actions trigger before regular actions. Multiple\n"
		"         multi-line actions can trigger per block. Packet fragmentation is not\n"
		"         currently handled.\n"
		"\n"
